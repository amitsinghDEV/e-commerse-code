...
const LogIn = () => {
  return (
    <div className='max-w-[1640px] mx-auto px-4 flex justify-center items-center my-8'>
      <div className='flex min-h-full flex-col justify-center px-6 py-12 lg:px-8'>
        <div className='sm:mx-auto sm:w-full sm:max-w-sm'>
          <h1 className='text-4xl md:text-8xl text-yellow-500 font-[Pacifico] text-center'>
            TARA
          </h1>
          <h2 className='mt-10 text-center text-2xl md:text-4xl font-bold leading-9 tracking-tight text-black'>
